...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { pregunta: @homework.pregunta, subject_id: @homework.subject_id, tema: @homework.tema }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { pregunta: @homework.pregunta, subject_id: @homework.subject_id, tema: @homework.tema }
    assert_redirected_to homework_path(assigns(:homework))
  end
