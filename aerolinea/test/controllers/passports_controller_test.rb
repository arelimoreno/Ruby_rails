...
class PassportsControllerTest < ActionController::TestCase
  ...
  test "should create passport" do
    assert_difference('Passport.count') do
      post :create, passport: { pilot_id: @passport.pilot_id, precio: @passport.precio, route_id: @passport.route_id, tipo: @passport.tipo }
    end
  ...
  test "should update passport" do
    patch :update, id: @passport, passport: { pilot_id: @passport.pilot_id, precio: @passport.precio, route_id: @passport.route_id, tipo: @passport.tipo }
    assert_redirected_to passport_path(assigns(:passport))
  end
