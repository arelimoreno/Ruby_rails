...
class PilotsControllerTest < ActionController::TestCase
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post :create, pilot: { cargo: @pilot.cargo, identificacion: @pilot.identificacion, user_id: @pilot.user_id }
    end
  ...
  test "should update pilot" do
    patch :update, id: @pilot, pilot: { cargo: @pilot.cargo, identificacion: @pilot.identificacion, user_id: @pilot.user_id }
    assert_redirected_to pilot_path(assigns(:pilot))
  end
